    ...
    <div id="data-list-list-view" class="data-list-container">
        ...
        <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="products">
            ...
            <template slot="thead">
                ...
                <vs-th sort-key="popularity">Contact Number</vs-th>
                <vs-th sort-key="order_status">Account Status</vs-th>
                <vs-th>Action</vs-th>
            </template>
            ...
            <template slot-scope="{data}">
                ...
                <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in products">
                    ...
                    <vs-td>
                        <p class="phone">{{tr.mobile_num}}</p>
                    </vs-td>

                    <vs-td>
                        <vs-chip  class="product-order-status text-white bg-success">
                            Active
                        </vs-chip>
                    </vs-td>

                    <vs-td class="whitespace-no-wrap">
                      <router-link :to="{ name:'seller-details' , params : { id :tr.id }}" >
                          <strong>
                              <feather-icon icon="InfoIcon" svgClasses="w-5 h-5 hover:text-primary stroke-current"/>
                          </strong>
                      </router-link>
...
<script>
    ...
    export default {
        ...
        created () {
            ...
            let obj = this;
            axios.get("http://127.0.0.1:8000/api/admin/sellers-list")
                .then(response => {
